...
return (
    <>
        {/* <Navbar /> */}
        <main>
            <section className="relative bg-sky-50 dark:bg-gray-900/30 pt-32 lg:pt-24 pb-32 lg:pb-4">
                <div className="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 relative">
                    <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 lg:-translate-x-0 lg:-translate-y-0 lg:left-0 lg:top-16 w-40 h-40 skew-x-6 opacity-50 dark:opacity-80 rounded-full bg-gradient-to-bl from-sky-600 to-sky-400 blur-3xl flex" />
                    <div className="flex text-center lg:text-left flex-col lg:items-center lg:flex-row gap-8 lg:gap-10 xl:gap-12 relative max-w-4xl lg:max-w-none -mt-24">
                        <div className="space-y-8 xl:space-y-10 lg:py-12 flex-1 lg:w-1/2 ">
                            <h1 className="text-sky-950 dark:text-white text-3xl/tight sm:text-4xl/tight md:text-5xl/tight xl:text-6xl/tight font-bold">
                            Welcome to  <span className="text-transparent bg-clip-text bg-gradient-to-br from-sky-700 to-sky-600">MedLink</span>    Find a Best Doctors for You

                            </h1>
                            <p className="text-gray-700 dark:text-gray-300 max-w-md mx-auto lg:max-w-none -mt-28">
                            Finding the right doctor has never been easier. At MedLink, we connect you with top healthcare professionals in your area, tailored to your specific medical needs. Whether you're looking for a primary care physician, a specialist, or urgent care, our user-friendly platform simplifies the process of finding and booking appointments.
                            </p>
                            <div className="flex flex-wrap items-center gap-4 z-30 sm:w-max sm:flex-nowrap mx-auto lg:mx-0">
                                <Link href="#" className="px-5 h-12 flex items-center sm:w-max w-full justify-center bg-gradient-to-br from-sky-700 to-sky-600 text-white rounded-lg ease-linear transition">
                                Find a Doctor
                                </Link>
                                <Link href="#" className="px-5 h-12 flex items-center sm:w-max w-full justify-center gap-x-3 border border-gray-200 dark:border-gray-900/60 rounded-lg text-sky-800 dark:text-gray-100 bg-sky-50 dark:bg-gray-900">
                            ...
                            <div className="max-w-lg lg:max-w-none mx-auto grid sm:grid-cols-3 divide-y divide-gray-100 dark:divide-gray-900 sm:divide-y-0 sm:gap-2 p-4 py-0 sm:py-4 text-left rounded-lg bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-900 shadow-sm shadow-gray-200/50 dark:shadow-transparent">
                                {
                                    metrics.map(metric => (
                                        <div key={metric.id} className="flex items-center gap-x-4 py-4 sm:py-0">
                                            <span className="w-10 h-10 text-white bg-gradient-to-br from-sky-700 to-sky-400 rounded-md flex items-center justify-center">
                                                {metric.icon}
                                            </span>
                        ...
                        <div aria-hidden="true" className="flex-1 lg:w-1/2 relative hidden lg:flex justify-end pr-8">
                            <div className="rounded-lg absolute right-0 bottom-0 w-11/12 h-2/5 bg-gradient-to-tr from-sky-50 to-sky-100 dark:bg-gradient-to-tr dark:from-gray-950 dark:to-gray-700" />
                            <Image src="/Medical Surgeon Doctor Stethoscope PNG.png" width={3200} height={1900} className="w-11/12 h-auto relative" alt="portrait-of-smiling-medical-worker-girl-doctor" />
                        </div>
                    </div>
                </div>
            </section>
