...
return (
    <footer className="pt-2">
        <div className="px-2 sm:px-0">
            <div className="mx-auto w-full max-w-6xl bg-sky-900 dark:bg-blue-950 p-5 sm:p-10 py-10 sm:py-14 md:py-16 rounded-3xl relative overflow-hidden">
                <div className="relative flex flex-col items-center text-center">
                    <h1 className="text-3xl sm:text-4xl md:text-5xl xl:text-6xl text-white font-bold max-w-4xl">Start Your Health Journey Today </h1>
                    <p className="text-base text-gray-300 max-w-xl mt-10"> Discover the easiest way to find and book appointments with top-rated doctors in your area. Visit MedLink and take control of your health today!</p>
